...
using grpc::Status;
using mjpg_streamer::Request;
using mjpg_streamer::Frame;
using mjpg_streamer::MjpgStreamer;

class MjpgStreamerServerImpl final : public MjpgStreamer::Service {

  Status StreamFrame(ServerContext* context, const Request* request, 
                     Frame* reply) override {
    reply->set_payload("hello world!");
    return Status::OK;
  }
};
